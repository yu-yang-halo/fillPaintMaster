...
- (void)setupNavBar {
    ...
    navBar.backgroundColor = [UIColor colorWithRed:6.0/255.0 green:6.0/255.0 blue:6.0/255.0 alpha:0.8];
    ...
    NSArray *cancelBtnCons1 = [NSLayoutConstraint constraintsWithVisualFormat:@"H:|-0-[cancelBtn(==60)]" options:0 metrics:nil views:NSDictionaryOfVariableBindings(cancelBtn)];
